...
export const RINGTONES: RingtoneData[] = [
	...
	{
		id: "warcraft-jobs-done",
		name: "Warcraft: Job's Done",
		description: "WC2 peasant completion callout",
		filename: "warcraft-jobs-done.mp3",
		emoji: "🪓",
		color: "from-yellow-500 to-amber-700",
		duration: 1,
	},
	{
		id: "redalert-tools-ready",
		name: "Red Alert: Tools Ready",
		description: "RA2 engineer ready callout",
		filename: "redalert-tools-ready.mp3",
		emoji: "🛠️",
